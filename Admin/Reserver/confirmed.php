<h3 class="pt-2">Hóa đơn/Đã xác nhận</h3>
<div class="row mb-3">
    <div class="col">
            ...
            <?php foreach ($row as $value) : ?>
                ...
                <td>
                    <form action="index.php?change_status_reserver" method="post">
                        <input type="hidden" name="status" value="Đang hoạt động">
                        <input type="hidden" name="id_reserver" value="<?= $value['id_reserver'] ?>">
                        <input type="hidden" name="id_villa_hidden" value="<?= $value['id_villa'] ?>">
                        <input type="submit" class="btn btn-success" value="Hoạt động">
                    </form>
                    <form action="index.php?change_status_reserver" method="post">
